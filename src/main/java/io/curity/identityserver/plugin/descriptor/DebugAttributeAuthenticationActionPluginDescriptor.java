...
import io.curity.identityserver.plugin.authenticationaction.debug.attribute.representations.IndexRepresentationFunction;
        ...
        implements AuthenticationActionPluginDescriptor<DebugAttributeAuthenticationActionConfiguration>
{
    ...
    {
        return Collections.singletonMap("index", IndexRepresentationFunction.class);
    }
}
